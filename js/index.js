...
function renderWhiteSauce() {
  ...
  sauceElements.forEach((sauce)=>{
    if (state.whiteSauce ==='sauce-white'){
...
function renderGlutenFreeCrust() {
  ...
  const crustElements = document.querySelectorAll('.crust');
  crustElements.forEach((crust)=>{
    if (state.glutenFreeCrust ==='crust-gluten-free'){
...
function renderPrice() {
  ...
  const pricePanel = document.querySelectorAll('panel price');
  pricePanel.innerHTML = `total price: `;
}
